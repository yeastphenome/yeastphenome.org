...
urlpatterns = [
    ...
    path("<int:gene_id>/similar/download/", views.download_gene_similarities, name='download_gene_similarities'),
    path("<int:gene_id>/scores/", views.gene_datasets, name="datasets"),
    path("<int:gene_id>/scores/download/", views.download_gene_scores, name="download_gene_scores"),
]
