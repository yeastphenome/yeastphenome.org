    ...
    var h = {
            ...
            show: function (t) {
                ...
                if ((!c || d || r.templates.dropdownItemNoMatch) && !1 !== r.dropdown.enable && !this.state.isLoading) {
                    if (
                        ...
                        t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t), r.templates.dropdownItemNoMatch && (s = r.templates.dropdownItemNoMatch.call(this, { value: t }))),
                        !s)
                    ) {
                        if (this.suggestedListItems.length) t && d && !this.state.editing.scope && !n(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({ value: t });
                        else {
                    ...
                    this.dropdown.fill.call(this, s),
                        r.dropdown.highlightFirst && this.dropdown.highlightOption.call(this, this.DOM.dropdown.content.children[0]),
                ...
                callbacks: {
                    onKeyDown: function (t) {
                        ...
                        switch (t.key) {
                            ...
                            case "Tab":
                                if ("mix" != this.settings.mode && !this.settings.autoComplete.rightKey && !this.state.editing) {
                                    try {
                            ...
                            case "Backspace":
                                ...
                                ("" != n && 8203 != n.charCodeAt(0)) || (!0 === this.settings.backspace ? this.removeTags() : "edit" == this.settings.backspace && setTimeout(this.editTag.bind(this), 0));
                        }
                    },
            ...
            highlightOption: function (t, e) {
                ...
                (i = this.suggestedListItems[this.getNodeIndex(t)]),
                    ...
                    this.settings.autoComplete && (this.input.autocomplete.suggest.call(this, i), "manual" != this.settings.dropdown.position && this.dropdown.position.call(this));
            },
            selectOption: function (t) {
                ...
                if (
                    ...
                    this.state.editing
                        ? this.onEditTagDone(this.state.editing.scope, s(s(s({}, this.state.editing.scope.__tagifyTagData), {}, { value: r.value }, r instanceof Object ? r : {}), {}, { __isValid: !0 }))
                        : this.addTags([r], a),
                    setTimeout(function () {
                ...
                for (
                    ...
                    d.fuzzySearch
                        ? ((s = p
                              ...
                              .toLowerCase()),
                          (i = (d.accentedSearch ? c(s).indexOf(c(n)) : s.indexOf(n)) >= 0))
                        : (i = p.some(function (t) {
                              var i = "" + e[t] || "";
                ...
                return t
                    .map(function (t, i) {
                        ...
                        var s = e.settings.dropdown.mapValueTo,
                            ...
                            n = d({}, t, { value: a && "string" == typeof a ? l(a) : a, tagifySuggestionIdx: i });
        ...
        callbacks: {
                        ...
                        case "Backspace":
                            ...
                            setTimeout(function () {
                                if (
                                    ...
                                    (e.removeTags(s.anchorNode.previousElementSibling), e.fixFirefoxLastTagNoCaret(), 2 == e.DOM.input.children.length && "BR" == e.DOM.input.children[1].tagName)
                                )
            ...
            onInput: function (t) {
                ...
                (s.isValid = this.validateTag({ value: e })),
                    ...
                    this.input.value != e &&
                        (this.input.set.call(this, e, !1), -1 != e.search(this.settings.delimiters) ? this.addTags(e) && this.input.set.call(this) : this.settings.dropdown.enabled >= 0 && this.dropdown[i ? "show" : "hide"].call(this, e));
            },
            onMixTagsInput: function (t) {
                ...
                if (window.getSelection && (r = window.getSelection()).rangeCount > 0 && 3 == r.anchorNode.nodeType) {
                    if (
                        ...
                        if (
                            ...
                            (this.state.tag = { prefix: n.match(g.pattern)[0], value: n.replace(g.pattern, "") }),
                            (this.state.tag.baseOffset = r.baseOffset - this.state.tag.value.length),
                            (c = this.state.tag.value.match(g.delimiters)))
                        )
                            return (
                                (this.state.tag.value = this.state.tag.value.replace(g.delimiters, "")), (this.state.tag.delimiters = c[0]), this.addTags(this.state.tag.value, g.dropdown.clearOnSelect), void this.dropdown.hide.call(this)
                            );
                ...
                setTimeout(function () {
                    h.update({ withoutChangeEvent: !0 }), h.trigger("input", d({}, h.state.tag, { textContent: h.DOM.input.textContent })), h.state.tag && h.dropdown[o ? "show" : "hide"].call(h, h.state.tag.value);
                }, 10);
            },
            ...
            onClickScope: function (t) {
                ...
                if (t.target != this.DOM.scope) {
                    if (!t.target.classList.contains(this.settings.classNames.tagX))
                        return e
                            ? (this.trigger("click", { tag: e, index: this.getNodeIndex(e), data: this.tagData(e), originalEvent: this.cloneEvent(t) }),
                              void (1 == this.settings.editTags && this.events.callbacks.onDoubleClickScope.call(this, t)))
                            : void (t.target == this.DOM.input && ("mix" == i.mode && this.fixFirefoxLastTagNoCaret(), s > 500)
                                  ? this.state.dropdown.visible
                                      ? this.dropdown.hide.call(this)
                                      : 0 === i.dropdown.enabled && "mix" != i.mode && this.dropdown.show.call(this)
                                  : "select" == i.mode && !this.state.dropdown.visible && this.dropdown.show.call(this));
            ...
            onEditTagInput: function (t, e) {
                ...
                o || !0 !== t.originalIsValid || (r = !0),
                    ...
                    n.length >= this.settings.dropdown.enabled && ((this.state.editing.value = n), this.dropdown.show.call(this, n)),
                    this.trigger("edit:input", { tag: i, index: s, data: d({}, this.value[s], { newValue: n }), originalEvent: this.cloneEvent(e) });
            },
            onEditTagFocus: function (t) {
                this.state.editing = { scope: t, input: t.querySelector("[contenteditable]") };
            },
            onEditTagBlur: function (t) {
                if (((this.state.editing = !1), this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t))) {
                    ...
                    n
                        ? (this.settings.transformTag.call(this, a),
                          !0 === (o = this.validateTag(a))
                              ? ((a = this.getWhitelistItemByValue(s) || a.__preInvalidData || {}), (a = Object.assign({}, a, { value: s })), this.settings.transformTag.call(this, a), this.onEditTagDone(e, a))
        ...
        (p.prototype = {
            ...
            applySettings: function (t, e) {
                ...
                if (
                    ...
                    "autoComplete" in e && !o(e.autoComplete) && ((i.autoComplete = this.DEFAULTS.autoComplete), (i.autoComplete.enabled = e.autoComplete)),
            ...
            isTagDuplicate: function (t) {
                ...
                return (
                    "select" != i.mode &&
                    this.value.reduce(function (s, a) {
                        return n(e.trim("" + t), a.value, i.dropdown.caseSensitive) ? s + 1 : s;
                    }, 0)
                );
            },
            ...
            validateTag: function (t) {
                ...
                return t.value.trim()
                    ? i.pattern && i.pattern instanceof RegExp && !i.pattern.test(e)
                        ...
                        : !(this.isTagBlacklisted(e) || (i.enforceWhitelist && !this.isTagWhitelisted(e))) || this.TEXTS.notAllowed
                    : this.TEXTS.empty;
            },
            ...
            getWhitelistItemByValue: function (t) {
                var e = this,
                    i = this.settings.whitelist.find(function (i) {
                        return n("string" == typeof i ? i : i.value, t, e.settings.dropdown.caseSensitive);
                    });
                return "string" == typeof i ? { value: i } : i;
            },
                          ...
                          : ("select" == n.mode && (e = !1),
                            ...
                            t.forEach(function (t) {
                                ...
                                if ((((t = Object.assign({}, r)).__isValid = i.hasMaxTags() || i.validateTag(t)), n.transformTag.call(i, t), !0 !== t.__isValid)) {
                                    if (s) return;
                                    d(o, i.getInvalidTagParams(t, t.__isValid), { __preInvalidData: r }), t.__isValid == i.TEXTS.duplicate && i.flashTag(i.getTagElmByValue(t.value));
                                }
